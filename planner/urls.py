...
urlpatterns = [
    ...
    path('menu/recette/<int:pk>/cuisine/', views.cook_mode, name='cook_mode'),
    ...
    path('reglages/checklist/<int:pk>/appliquer/', views.apply_checklist, name='apply_checklist'),
    path('reglages/checklist/<int:pk>/supprimer/', views.delete_checklist, name='delete_checklist'),
    path('reglages/rappel/<int:pk>/supprimer/', views.delete_reminder, name='delete_reminder'),
    path('reglages/rappel/<int:pk>/basculer/', views.toggle_reminder, name='toggle_reminder'),
